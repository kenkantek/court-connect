...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('search', ['as' => 'home.search', 'uses' => 'HomeController@getSearch']);
	...
	Route::get('search', ['as' => 'home.search', 'uses' => 'HomeController@showSearch']);
	Route::post('search', ['as' => 'home.search', 'uses' => 'HomeController@postSearch']);
