...
@section('content-setting')
    ...
    <div class="panel panel-primary ">
        ...
        <!-- form start -->
            {!! Form::open(array('url' => route('admin.setting.pages.edit',$item->id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
            <div class="col-md-12">
                <div class="box-body">
                    <div class="form-group">
                        {!! Form::label('title', 'Title',['class'=>'col-sm-2 control-label text-left']) !!}
                        <div class="col-sm-10">
                            {!! Form::text('title', $item->title, array('id'=>'','class' => 'form-control', 'required' => 'required', 'placeholder'=> 'Title')) !!}
                        </div>
                    </div>
                    <div class="form-group">
