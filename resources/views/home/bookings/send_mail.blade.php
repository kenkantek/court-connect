    ...
    <tr style="background: url({{ url("/")."/resources/home/images/header-bg.jpg"}}) ">
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:10px 0 0">
                ...
                <tr>
                    <td>
                        <img src="{{url("/")}}/resources/home/images/logo_02.png" width="166" height="96" alt="logo court connect" class="CToWUd"></td>
                        {{--<img src="http://i.imgur.com/W6pvwfZ.png" width="166" height="96" alt="logo court connect" class="CToWUd"></td>--}}
                    <td align="right" valign="top"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#333333;line-height:18px"><br></td>
                </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr>
        <td>
            <div style="line-height:18px;color:#333">
                ...
                <div style="background:#eff0f4;border:10px solid #e2e2e2;box-sizing: border-box;margin-top:10px;width:100%;box-sizing: border-box;">
